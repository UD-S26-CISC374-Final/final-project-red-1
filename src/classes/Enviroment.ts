    ...
    private updateEnviromentState(): string {
        ...
        if (currentFolder.name == "AlchemyRoom") {
            ...
            if (this.unlockedKey) {
                ...
                const tempGrab1 = this.nav.getFileDeep("Door");
            ...
            if (this.throneOpened) {
                ...
                const tempGrab2 = this.nav.getFileDeep("ThroneRoom");
    ...
    */
    private executeFile(name: string): string {
        ...
        if (name === "Potion3.exe") {
            ...
            const tempFile1 = this.nav.getFileDeep("UnturnedKey");

            if (tempFile1 instanceof File) {
                returnMessage += "And the key tries to turn...";

                const knob = this.nav.getFileDeep("Door");
